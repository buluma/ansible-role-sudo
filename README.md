...
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-sudo/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-sudo/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-sudo.svg)](https://github.com/buluma/ansible-role-sudo/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-sudo.svg)](https://github.com/buluma/ansible-role-sudo/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-sudo.svg)](https://github.com/buluma/ansible-role-sudo/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/sudo)](https://galaxy.ansible.com/ui/standalone/roles/buluma/sudo/documentation)|
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-sudo/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-sudo
